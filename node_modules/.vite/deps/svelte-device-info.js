// node_modules/svelte-device-info/dist/svelte-device-info.esm.js
var memoized = {};
...
function DeviceCanHover() {
  ...
  return memoized.DeviceCanHover;
}
...
function AppRunsOnLegacyTouchDevice() {
  if (memoized.AppRunsOnLegacyTouchDevice == null) {
    memoized.AppRunsOnLegacyTouchDevice = !MediaQuery("(pointer:fine)") && !MediaQuery("(pointer:coarse)") && !MediaQuery("-moz-touch-enabled") && ("ontouchstart" in Window || (navigator.maxTouchPoints || 0) > 0 || /touch|android|iphone|ipod|ipad/i.test(navigator.userAgent));
  }
...
function DevicePointingAccuracy() {
  ...
  return memoized.DevicePointingAccuracy;
}
function updateDevicePointingAccuracy() {
  ...
  if (DocumentIsReady()) {
    ...
    if (updatedPointingAccuracy === "none" !== ClassList.contains("noPointer") || updatedPointingAccuracy === "fine" !== ClassList.contains("finePointer") || updatedPointingAccuracy === "coarse" !== ClassList.contains("coarsePointer")) {
...
function registerHandler(Handler, onceOnly) {
  ...
  var EventHandlerRegistry = memoized.EventHandlerRegistry;
...
function unobservePointingAccuracy() {
  ...
  memoized.AccuracyPoller = void 0;
}
...
var svelteDeviceInfo = {
  ...
  get isTablet() {
    return DeviceIsMobile() && !DeviceIsPhone();
  },
  get isLegacyTouchDevice() {
    return AppRunsOnLegacyTouchDevice();
  },
  rewriteMediaQueriesOnLegacyTouchDevices,
  get PointingAccuracy() {
    return DevicePointingAccuracy();
  },
  get canHover() {
    return DeviceCanHover();
  },
  onPointingAccuracyChanged,
  oncePointingAccuracyChanged,
  offPointingAccuracyChanged,
  get observesPointingAccuracy() {
    return memoized.AccuracyPoller != null;
  }
};
var svelte_device_info_esm_default = svelteDeviceInfo;
export {
  svelte_device_info_esm_default as default
};
